...
class JobApplicationSchema(Schema):
    ...
    advertisement = fields.Nested("AdvertisementSchema",exclude=("job_applications","recruiter.job_applications",))
    state = fields.Enum(ApplicationState)
    messages = fields.Nested("MessageSchema",many=True,exclude=("job_application","author.job_applications","author.created_advertisements"))
