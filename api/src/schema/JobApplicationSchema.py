...
class JobApplicationSchema(Schema):
    ...
    advertisement = fields.Nested("AdvertisementSchema", exclude=( "job_applications", "recruiter.skills","recruiter.created_advertisements","recruiter.company","recruiter.job_applications", "skills", "company.advertisements","company.users" ))
