  ...
  return (
      <div className="w-screen h-screen flex flex-column">
            <div className="box-content w-5/6 m-4 p-4 shadow-md rounded-md">
                <h1 className="items-center justify-center">{data.name.toUpperCase()}</h1>
                <span className="text-gray-400 italic">{data.contract_type.replace("_"," ")}</span>
                <span> - </span>
                <span className="text-gray-400 italic">{data.place}</span>
                <hr />
                <br />
                <h2>Posted by {data.recruiter.firstname} {data.recruiter.lastname}</h2>
                <br />
